...
export const CATEGORIES = [
  ...
  { id: 'Pickleball', name: 'Pickleball', icon: 'tennis-ball' as const },
  { id: 'Badminton', name: 'Cầu lông', icon: 'badminton' as const },
  { id: 'Football 5', name: 'Bóng đá 5', icon: 'soccer-field' as const },
  { id: 'Football 7', name: 'Bóng đá 7', icon: 'soccer' as const },
  { id: 'Tennis', name: 'Tennis', icon: 'tennis' as const },
];
